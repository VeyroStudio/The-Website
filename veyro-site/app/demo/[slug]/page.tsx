...
/**
 * Demo home page. The other pages carry the depth; this one's job is
 * the first impression — full-height Ken Burns hero, cascading text,
 * and teasers that pull the prospect into Prices and Gallery so they
 * feel the multi-page structure.
 */
    ...
    <>
      ...
      <section className="relative flex min-h-[92svh] items-end overflow-hidden pt-16">
        ...
        <div className="relative mx-auto w-full max-w-5xl px-4 pb-16">
          ...
          <h1
            className="demo-rise mt-3 [font-family:var(--font-demo-display)] text-[clamp(3.5rem,14vw,8rem)] leading-[0.9] tracking-wide"
